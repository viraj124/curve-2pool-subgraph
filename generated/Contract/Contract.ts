...
export class Contract extends ethereum.SmartContract {
  ...
  get_balances(): Array<BigInt> {
    let result = super.call("get_balances", "get_balances():(uint256[2])", []);

    return result[0].toBigIntArray();
  }

  try_get_balances(): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "get_balances",
      "get_balances():(uint256[2])",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
